...
window.QUESTION_BANK = {
  ...
  'lang-kr-quarantine': [
    { text:'請問下列何者是「入境」的意思?', options:['비행기표 <data-audio="audio/檢疫單字 韓文/機票.mp3">','여권<data-audio="audio/檢疫單字 韓文/護照.mp3">','입국<data-audio="audio/檢疫單字 韓文/入境.mp3">','환승<data-audio="audio/檢疫單字 韓文/轉機.mp3">'], answer:2 },
    { text:'請問下列何者是「轉機」的意思?', options:['비행기표 <data-audio="audio/檢疫單字 韓文/機票.mp3">','여권<data-audio="audio/檢疫單字 韓文/護照.mp3">','입국<data-audio="audio/檢疫單字 韓文/入境.mp3">','환승<data-audio="audio/檢疫單字 韓文/轉機.mp3">'], answer:3 },
    { text:'請問下列何者是「機票」的意思?', options:['비행기표 <data-audio="audio/檢疫單字 韓文/機票.mp3">','여권<data-audio="audio/檢疫單字 韓文/護照.mp3">','입국<data-audio="audio/檢疫單字 韓文/入境.mp3">','환승<data-audio="audio/檢疫單字 韓文/轉機.mp3">'], answer:0 },
    { text:'請問下列何者是「護照」的意思?', options:['비행기표 <data-audio="audio/檢疫單字 韓文/機票.mp3">','여권<data-audio="audio/檢疫單字 韓文/護照.mp3">','입국<data-audio="audio/檢疫單字 韓文/入境.mp3">','환승<data-audio="audio/檢疫單字 韓文/轉機.mp3">'], answer:1 },
