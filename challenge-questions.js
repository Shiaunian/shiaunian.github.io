...
window.QUESTION_BANK = {
  ...
  'lang-kr-quarantine': [
    { text:'請問下列何者是「入境」的意思?', options:['<img src="audio/檢疫單字 韓文/機票.mp3">비행기표','<img src="audio/檢疫單字 韓文/護照.mp3">여권','<img src="audio/檢疫單字 韓文/入境.mp3">입국','<img src="audio/檢疫單字 韓文/轉機.mp3">환승'], answer:2 },
    { text:'請問下列何者是「轉機」的意思?', options:['<img src="audio/檢疫單字 韓文/機票.mp3">비행기표','<img src="audio/檢疫單字 韓文/護照.mp3">여권','<img src="audio/檢疫單字 韓文/入境.mp3">입국','<img src="audio/檢疫單字 韓文/轉機.mp3">환승'], answer:3 },
    { text:'請問下列何者是「機票」的意思?', options:['<img src="audio/檢疫單字 韓文/機票.mp3">비행기표','<img src="audio/檢疫單字 韓文/護照.mp3">여권','<img src="audio/檢疫單字 韓文/入境.mp3">입국','<img src="audio/檢疫單字 韓文/轉機.mp3">환승'], answer:0 },
    { text:'請問下列何者是「護照」的意思?', options:['<img src="audio/檢疫單字 韓文/機票.mp3">비행기표','<img src="audio/檢疫單字 韓文/護照.mp3">여권','<img src="audio/檢疫單字 韓文/入境.mp3">입국','<img src="audio/檢疫單字 韓文/轉機.mp3">환승'], answer:1 },
    ...
    { text:'請問下列何者是「肉乾」的意思?', options:['돼지고기','닭고기','소고기','육포'},
