...
window.QUESTION_BANK = {
  ...
  'lang-kr-quarantine': [
    ...
    { text:'請問下列何者是圖片的翻譯?', image:'audio/水果.jpg', options:['과일','소시지','쌀','햄'], answer:0 },
    { text:'請問下列何者是圖片的翻譯?', image:'audio/火腿.jpg', options:['과일','소시지','쌀','햄'], answer:3 },
    { text:'請問下列何者是圖片的翻譯?', image:'audio/香腸.jpg', options:['과일','소시지','쌀','햄'], answer:1 },
    { text:'請問下列何者是圖片的翻譯?', image:'audio/米.jpg', options:['과일','소시지','쌀','햄'], answer:2 },
    { text:'請問下列何者是圖片的翻譯?', image:'audio/生菜.jpg', options:['상추','빵','과자','씨앗'], answer:0 },
    { text:'請問下列何者是圖片的翻譯?', image:'audio/麵包.jpg', options:['상추','빵','과자','씨앗'], answer:1 },
    ...
    { text:'請問下列何者是圖片的翻譯?', image:'audio/雞蛋.jpg', options:['김밥','계란','반숙','완숙'], answer:1 },
