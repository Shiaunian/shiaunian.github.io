...
window.QUESTION_BANK = {
  ...
  // ===========================
    ...
    { text:'填空題：During the experiment, a constant temperature of 28°C was ___ while the amount of sunlight was gradually increased.', options:['maintained','performed','continued','expanded'], answer:0 },
    { text:'填空題：Construction of the new highway system ___ completed on time if more workers had been hired.', options:['needs to be','would have been','will be','should have'], answer:1 },
    { text:'填空題：Mary is one of my best friends, but sometimes the way she keeps changing her mind ___ on my nerves.', options:['getting','gotten','to get','gets'], answer:3 },
    { text:'填空題：Nepal, a small country located between Tibet and India, has ___ of 11.3 million, most of whom are Mongol or Aryan.', options:['arms','taxation','population','a land'], answer:2 },
    ...
    { text:'填空題：Over the past three decades, Lin Hwai-min ___ himself to be a choreographer of great ambition, courage, and genius.', options:['was proving','will prove','has been proven','has proved'], answer:3 },
    { text:'填空題：There are many ___ along the road to success, but we should never give up.', options:['ornaments','obstacles','beverages','souvenirs'], answer:1 },
    { text:'填空題：Lisa ___ listening to a free English podcast before going to bed.', options:['being used to','is used to','used to','used to be'], answer:1 },
    { text:'填空題：On the street ___ crying for his mother.', options:['a little boy is','is a little boy','a little boy who','where a little boy'], answer:3 },
    { text:'填空題：Construction of the new railroad system ___ completed years ago if the budget had been taken out.', options:['needs to be','would have been','will be','should have'], answer:1 },
    { text:"填空題：You can't just fool around, ___ about nothing.", options:['cared','to care','to be cared','caring'], answer:3 },
    { text:'填空題：Denny was able to ___ difficulties and won a scholarship.', options:['overcome','present','declare','provide'], answer:0 },
    { text:'填空題：Sometimes parents have problems ___ with their children due to  the generation gap.', options:['communicate','communicated','communicating','to communicate'], answer:2 },
    { text:'填空題：After a ___ period of investigation, the judge found the suspect innocent and set him free at last.', options:['prolonged','confined','fascinating','satisfying'], answer:0 },
    { text:'填空題：The ball game was supposed to start at 9 a.m., but it was ___ because of a shower of rain.', options:['postponed','substituted','twisted','appeared'], answer:1 },
    { text:'填空題：The ability ___ ideas and images for years and years is referred to it as long-term memory.', options:['to hold','be holding','held','is held'], answer:0 },
    { text:"填空題：The police officer was ___ about what the suspect said, he didn't believe that the suspect was innocent.", options:['believable','unbelievable','doubtfully','doubtful'], answer:3 },
    { text:'填空題：Do you know if ther4e is any shop nearby ___ I can get a pair of shoes?', options:['as','while','doubtfully','which'], answer:2 },
    { text:'填空題：Smoking pork ___ the meat from rotting as well as salting does.', options:['prevents','preventing','prevent','to prevent'], answer:0 },
    { text:'填空題：The truth about the whole thing is about to ___ . Soon, the public will know more about what really happened.', options:['merge','emerge','conceal','confess'], answer:1 },
    { text:"填空題：The adventurer always tends to ___ when people ask him about his life in the Amazon jungle.", options:['cooperate','demonstrate','immigrate','exaggerate'], answer:3 },
    { text:'填空題：It is time that you ___ fooling around and concentrated on your studies.', options:['stops','stopped','stopping','stop'], answer:1 },
    { text:"填空題：It ___ rain tomorrow, but I'm not sure.", options:['can','may','be','must'], answer:1 },
    { text:"填空題：Keeping early hours is ___ to one's health.", options:['financial','official','beneficial','special'], answer:2 },
    { text:'填空題：Only when you become a parent yourself ___ the difficult situations your parents have been through when they raised you.', options:['you realize','do you realize','you realize how','and then you realize'], answer:1 },
    { text:'填空題：Had the navy known about the attack in advance, they ___ the fleet to get out of Pearl Harbor.', options:['would certainly order','would certainly have ordered','certainly ordered','had certainly ordered'], answer:1 },
    { text:"填空題：Some of the senior citizens ___ in the area would take part in the performance.", options:['to live','live','living','lived'], answer:2 },
    { text:'填空題：A training ___ for new employees will be held in the conference room next weekend.', options:['device','facility','catalogue','session'], answer:3 },
    { text:'填空題：___ wars, diseases, and natural disasters, our world is experiencing a population explosion that may change the way we live.', options:['Although','Since','Unless','Despite'], answer:3 },
    { text:'填空題：Vicky is cautious about spending her money, so she is not ___ to buy something unnecessary.', options:['like','likely','unlike','likewise'], answer:1 },
    { text:"填空題：Copper prices ___ by about 40% since the stat of the year.", options:['rose','risen','were risen','have risen'], answer:3 },
    { text:"填空題：Jason's book ___ some similarities to that of a famous writer.", options:['keeps','makes','bears','veils'], answer:2 },
    { text:"填空題：___ should you reveal this secret to others.", options:['Seldom','Little','Never','Hardly'], answer:2 },
    { text:"填空題：We offer some books and documents for ___ in the history of the city.", options:['anyone interested','anyone who interested','one interesting','one to interest'], answer:0 },
    { text:'填空題：Dr. Webber is ___ the death of his patient.', options:['essential for','necessary for','responsible for','difficult for'], answer:2 },
    { text:'填空題：Thousands of protesters ___ roads near the City Hall for six hours.', options:['were blocking','will block','had blocked','have been blocking'], answer:3 },
    { text:"填空題：Joanna is a very ___ actress who has played many different characters in movies.", options:['tolerant','brutal','versatile','consequent'], answer:2 },
    { text:'填空題：There is no ___ that this oil painting is a masterpiece.', options:['to deny','denies','denied','denying'], answer:3 },
    { text:'填空題：Stanley might be too young to play professional basketball, but he has great ___ .', options:['resistance','potential','improvement','devotion'], answer:1 },
    { text:"填空題：If it had not been for Ken's encouragement, I ___ given up my career.", options:['have been','would have','will be','should'], answer:1 },
    ...
    { text:'填空題：I like to sit in a coffee ship and ___ people on the street.', options:['observe','offend','browse','ban'], answer:0 },
    { text:"填空題：___ the novel sold millions of copies, it didn't receive high praise form literary critics.", options:['As a result','Although','In a word','Regardless of'], answer:1 },
    { text:"填空題：People respond ___ to stress. Some take it calmy, while others don't.", options:['sincerely','incredibly','apparently','differently'], answer:3 },
  ...
  'lang-kr-quarantine': [
    { text:'請問下列何者是「入境」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/機票.mp3</audio>비행기표','<audio id="qaAudio">audio/檢疫單字 韓文/護照.mp3</audio>여권','<audio id="qaAudio">audio/檢疫單字 韓文/入境.mp3</audio>입국','<audio id="qaAudio">audio/檢疫單字 韓文/轉機.mp3</audio>환승'], answer:2 },
    { text:'請問下列何者是「轉機」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/機票.mp3</audio>비행기표','<audio id="qaAudio">audio/檢疫單字 韓文/護照.mp3</audio>여권','<audio id="qaAudio">audio/檢疫單字 韓文/入境.mp3</audio>입국','<audio id="qaAudio">audio/檢疫單字 韓文/轉機.mp3</audio>환승'], answer:3 },
    { text:'請問下列何者是「機票」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/機票.mp3</audio>비행기표','<audio id="qaAudio">audio/檢疫單字 韓文/護照.mp3</audio>여권','<audio id="qaAudio">audio/檢疫單字 韓文/入境.mp3</audio>입국','<audio id="qaAudio">audio/檢疫單字 韓文/轉機.mp3</audio>환승'], answer:0 },
    { text:'請問下列何者是「護照」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/機票.mp3</audio>비행기표','<audio id="qaAudio">audio/檢疫單字 韓文/護照.mp3</audio>여권','<audio id="qaAudio">audio/檢疫單字 韓文/入境.mp3</audio>입국','<audio id="qaAudio">audio/檢疫單字 韓文/轉機.mp3</audio>환승'], answer:1 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/手機.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/手機.mp3</audio>핸드폰','<audio id="qaAudio">audio/檢疫單字 韓文/左轉.mp3</audio>왼쪽','<audio id="qaAudio">audio/檢疫單字 韓文/海關.mp3</audio>세관','<audio id="qaAudio">audio/檢疫單字 韓文/行李.mp3</audio>수하물'], answer:0 },
    { text:'請問下列何者是「行李」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/手機.mp3</audio>핸드폰','<audio id="qaAudio">audio/檢疫單字 韓文/左轉.mp3</audio>왼쪽','<audio id="qaAudio">audio/檢疫單字 韓文/海關.mp3</audio>세관','<audio id="qaAudio">audio/檢疫單字 韓文/行李.mp3</audio>수하물'], answer:3 },
    { text:'請問下列何者是「海關」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/手機.mp3</audio>핸드폰','<audio id="qaAudio">audio/檢疫單字 韓文/左轉.mp3</audio>왼쪽','<audio id="qaAudio">audio/檢疫單字 韓文/海關.mp3</audio>세관','<audio id="qaAudio">audio/檢疫單字 韓文/行李.mp3</audio>수하물'], answer:2 },
    { text:'請問下列何者是「左邊」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/手機.mp3</audio>핸드폰','<audio id="qaAudio">audio/檢疫單字 韓文/左轉.mp3</audio>왼쪽','<audio id="qaAudio">audio/檢疫單字 韓文/海關.mp3</audio>세관','<audio id="qaAudio">audio/檢疫單字 韓文/行李.mp3</audio>수하물'], answer:1 },
    { text:'請問下列何者是「右邊」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/登機門.mp3</audio>탑승구','<audio id="qaAudio">audio/檢疫單字 韓文/包包.mp3</audio>가방','<audio id="qaAudio">audio/檢疫單字 韓文/右轉.mp3</audio>오른쪽','<audio id="qaAudio">audio/檢疫單字 韓文/糖果.mp3</audio>사탕'], answer:2 },
    { text:'請問下列何者是「登機門」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/登機門.mp3</audio>탑승구','<audio id="qaAudio">audio/檢疫單字 韓文/包包.mp3</audio>가방','<audio id="qaAudio">audio/檢疫單字 韓文/右轉.mp3</audio>오른쪽','<audio id="qaAudio">audio/檢疫單字 韓文/糖果.mp3</audio>사탕'], answer:0 },
    { text:'請問下列何者是「包包」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/登機門.mp3</audio>탑승구','<audio id="qaAudio">audio/檢疫單字 韓文/包包.mp3</audio>가방','<audio id="qaAudio">audio/檢疫單字 韓文/右轉.mp3</audio>오른쪽','<audio id="qaAudio">audio/檢疫單字 韓文/糖果.mp3</audio>사탕'], answer:1 },
    { text:'請問下列何者是「糖果」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/登機門.mp3</audio>탑승구','<audio id="qaAudio">audio/檢疫單字 韓文/包包.mp3</audio>가방','<audio id="qaAudio">audio/檢疫單字 韓文/右轉.mp3</audio>오른쪽','<audio id="qaAudio">audio/檢疫單字 韓文/糖果.mp3</audio>사탕'], answer:3 },
    { text:'請問下列何者是「豬肉」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/豬肉.mp3</audio>돼지고기','<audio id="qaAudio">audio/檢疫單字 韓文/雞肉.mp3</audio>닭고기','<audio id="qaAudio">audio/檢疫單字 韓文/牛肉.mp3</audio>소고기','<audio id="qaAudio">audio/檢疫單字 韓文/肉乾.mp3</audio>육포'], answer:0 },
    { text:'請問下列何者是「雞肉」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/豬肉.mp3</audio>돼지고기','<audio id="qaAudio">audio/檢疫單字 韓文/雞肉.mp3</audio>닭고기','<audio id="qaAudio">audio/檢疫單字 韓文/牛肉.mp3</audio>소고기','<audio id="qaAudio">audio/檢疫單字 韓文/肉乾.mp3</audio>육포'], answer:1 },
    { text:'請問下列何者是「牛肉」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/豬肉.mp3</audio>돼지고기','<audio id="qaAudio">audio/檢疫單字 韓文/雞肉.mp3</audio>닭고기','<audio id="qaAudio">audio/檢疫單字 韓文/牛肉.mp3</audio>소고기','<audio id="qaAudio">audio/檢疫單字 韓文/肉乾.mp3</audio>육포'], answer:2 },
    { text:'請問下列何者是「肉乾」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/豬肉.mp3</audio>돼지고기','<audio id="qaAudio">audio/檢疫單字 韓文/雞肉.mp3</audio>닭고기','<audio id="qaAudio">audio/檢疫單字 韓文/牛肉.mp3</audio>소고기','<audio id="qaAudio">audio/檢疫單字 韓文/肉乾.mp3</audio>육포'], answer:3 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/水果.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/水果.mp3</audio>과일','<audio id="qaAudio">audio/檢疫單字 韓文/香腸.mp3</audio>소시지','<audio id="qaAudio">audio/檢疫單字 韓文/米.mp3</audio>쌀','<audio id="qaAudio">audio/檢疫單字 韓文/火腿.mp3</audio>햄'], answer:0 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/火腿.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/水果.mp3</audio>과일','<audio id="qaAudio">audio/檢疫單字 韓文/香腸.mp3</audio>소시지','<audio id="qaAudio">audio/檢疫單字 韓文/米.mp3</audio>쌀','<audio id="qaAudio">audio/檢疫單字 韓文/火腿.mp3</audio>햄'], answer:3 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/香腸.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/水果.mp3</audio>과일','<audio id="qaAudio">audio/檢疫單字 韓文/香腸.mp3</audio>소시지','<audio id="qaAudio">audio/檢疫單字 韓文/米.mp3</audio>쌀','<audio id="qaAudio">audio/檢疫單字 韓文/火腿.mp3</audio>햄'], answer:1 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/米.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/水果.mp3</audio>과일','<audio id="qaAudio">audio/檢疫單字 韓文/香腸.mp3</audio>소시지','<audio id="qaAudio">audio/檢疫單字 韓文/米.mp3</audio>쌀','<audio id="qaAudio">audio/檢疫單字 韓文/火腿.mp3</audio>햄'], answer:2 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/生菜.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/生菜.mp3</audio>상추','<audio id="qaAudio">audio/檢疫單字 韓文/麵包.mp3</audio>빵','<audio id="qaAudio">audio/檢疫單字 韓文/甜食.mp3</audio>과자','<audio id="qaAudio">audio/檢疫單字 韓文/種子.mp3</audio>씨앗'], answer:0 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/麵包.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/生菜.mp3</audio>상추','<audio id="qaAudio">audio/檢疫單字 韓文/麵包.mp3</audio>빵','<audio id="qaAudio">audio/檢疫單字 韓文/甜食.mp3</audio>과자','<audio id="qaAudio">audio/檢疫單字 韓文/種子.mp3</audio>씨앗'], answer:1 },
    { text:'請問下列何者是「甜食」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/生菜.mp3</audio>상추','<audio id="qaAudio">audio/檢疫單字 韓文/麵包.mp3</audio>빵','<audio id="qaAudio">audio/檢疫單字 韓文/甜食.mp3</audio>과자','<audio id="qaAudio">audio/檢疫單字 韓文/種子.mp3</audio>씨앗'], answer:2 },
    { text:'請問下列何者是「種子」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/生菜.mp3</audio>상추','<audio id="qaAudio">audio/檢疫單字 韓文/麵包.mp3</audio>빵','<audio id="qaAudio">audio/檢疫單字 韓文/甜食.mp3</audio>과자','<audio id="qaAudio">audio/檢疫單字 韓文/種子.mp3</audio>씨앗'], answer:3 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/飯捲.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/飯捲.mp3</audio>김밥','<audio id="qaAudio">audio/檢疫單字 韓文/雞蛋.mp3</audio>계란','<audio id="qaAudio">audio/檢疫單字 韓文/半熟.mp3</audio>반숙','<audio id="qaAudio">audio/檢疫單字 韓文/全熟.mp3</audio>완숙'], answer:0 },
    { text:'請問下列何者是「半熟」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/飯捲.mp3</audio>김밥','<audio id="qaAudio">audio/檢疫單字 韓文/雞蛋.mp3</audio>계란','<audio id="qaAudio">audio/檢疫單字 韓文/半熟.mp3</audio>반숙','<audio id="qaAudio">audio/檢疫單字 韓文/全熟.mp3</audio>완숙'], answer:2 },
    { text:'請問下列何者是「全熟」的意思?', options:['<audio id="qaAudio">audio/檢疫單字 韓文/飯捲.mp3</audio>김밥','<audio id="qaAudio">audio/檢疫單字 韓文/雞蛋.mp3</audio>계란','<audio id="qaAudio">audio/檢疫單字 韓文/半熟.mp3</audio>반숙','<audio id="qaAudio">audio/檢疫單字 韓文/全熟.mp3</audio>완숙'], answer:3 },
    { text:'請問下列何者是圖中內容的翻譯?', image:'audio/雞蛋.jpg', options:['<audio id="qaAudio">audio/檢疫單字 韓文/飯捲.mp3</audio>김밥','<audio id="qaAudio">audio/檢疫單字 韓文/雞蛋.mp3</audio>계란','<audio id="qaAudio">audio/檢疫單字 韓文/半熟.mp3</audio>반숙','<audio id="qaAudio">audio/檢疫單字 韓文/全熟.mp3</audio>완숙'], answer:1 },
  ...
  'lang-jp-quarantine': [
    { text:'請問下列何者是「入境」的意思?', options:['入国','乗り継ぎ','搭乗券','バスボード'], answer:0 },
    { text:'請問下列何者是「轉機」的意思?', options:['入国','乗り継ぎ','搭乗券','バスボード'], answer:1 },
    { text:'請問下列何者是「機票」的意思?', options:['入国','乗り継ぎ','搭乗券','バスボード'], answer:2 },
    { text:'請問下列何者是「護照」的意思?', options:['入国','乗り継ぎ','搭乗券','バスボード'], answer:3 },
    { text:'請問下列何者是「手機」的意思?', options:['入国審査','スマホ','お預け手荷物','荷物'], answer:1 },
    { text:'請問下列何者是「行李」的意思?', options:['入国審査','スマホ','お預け手荷物','荷物'], answer:3 },
    { text:'請問下列何者是「護照查驗」的意思?', options:['入国審査','スマホ','お預け手荷物','荷物'], answer:0 },
    { text:'請問下列何者是「托運行李」的意思?', options:['入国審査','スマホ','お預け手荷物','荷物'], answer:2 },
    { text:'請問下列何者是「海關」的意思?', options:['みぎ','ひだり','ぜいかん','ゲート'], answer:2 },
    { text:'請問下列何者是「左邊」的意思?', options:['みぎ','ひだり','ぜいかん','ゲート'], answer:0 },
    { text:'請問下列何者是「右邊」的意思?', options:['みぎ','ひだり','ぜいかん','ゲート'], answer:1 },
    { text:'請問下列何者是「登機門」的意思?', options:['みぎ','ひだり','ぜいかん','ゲート'], answer:3 },
    { text:'請問下列何者是「直走」的意思?', options:['鶏肉','カバン','まっすぐ行って','豚肉'], answer:2 },
    { text:'請問下列何者是「包包」的意思?', options:['鶏肉','カバン','まっすぐ行って','豚肉'], answer:1 },
    { text:'請問下列何者是「豬肉」的意思?', options:['鶏肉','カバン','まっすぐ行って','豚肉'], answer:3 },
    { text:'請問下列何者是「雞肉」的意思?', options:['鶏肉','カバン','まっすぐ行って','豚肉'], answer:0 },
    { text:'請問下列何者是「牛肉」的意思?', options:['牛肉','リンゴ','バナナ','ミカン'], answer:0 },
    { text:'請問下列何者是「蘋果」的意思?', options:['牛肉','リンゴ','バナナ','ミカン'], answer:1 },
    { text:'請問下列何者是「香蕉」的意思?', options:['牛肉','リンゴ','バナナ','ミカン'], answer:2 },
    { text:'請問下列何者是「牛肉」的意思?', options:['牛肉','リンゴ','バナナ','ミカン'], answer:3 },
    { text:'請問下列何者是「肉乾」的意思?', options:['腸詰め','ぞぼる','ハム','干し肉'], answer:3 },
    { text:'請問下列何者是「肉鬆」的意思?', options:['腸詰め','ぞぼる','ハム','干し肉'], answer:1 },
    { text:'請問下列何者是圖中內容的翻譯?',image:'audio/火腿.jpg', options:['腸詰め','ぞぼる','ハム','干し肉'], answer:2 },
    { text:'請問下列何者是「肉乾」的意思?', options:['腸詰め','ぞぼる','ハム','干し肉'], answer:3 },
    { text:'請問下列何者是圖中內容的翻譯?',image:'audio/香腸.jpg', options:['腸詰め','ぞぼる','ハム','干し肉'], answer:0 },
    { text:'請問下列何者是圖中內容的翻譯?',image:'audio/米.jpg', options:['パン','こめ','生野菜','あめ'], answer:1 },
    { text:'請問下列何者是圖中內容的翻譯?',image:'audio/生菜.jpg', options:['パン','こめ','生野菜','あめ'], answer:2 },
    { text:'請問下列何者是圖中內容的翻譯?',image:'audio/麵包.jpg', options:['パン','こめ','生野菜','あめ'], answer:0 },
    { text:'請問下列何者是「糖果」的意思?', options:['パン','こめ','生野菜','あめ'], answer:3 },
    { text:'請問下列何者是「餅乾」的意思?', options:['あまい','しゅし','おかし','クーキー'], answer:3 },
    { text:'請問下列何者是「甜食」的意思?', options:['あまい','しゅし','おかし','クーキー'], answer:2 },
    { text:'請問下列何者是「種子」的意思?', options:['あまい','しゅし','おかし','クーキー'], answer:1 },
    { text:'請問下列何者是「甜的」的意思?', options:['あまい','しゅし','おかし','クーキー'], answer:0 },
    { text:'請問下列何者是「生的」的意思?', options:['なま','半熟','よく焼き','ほうすい'], answer:0 },
    { text:'請問下列何者是「熟的」的意思?', options:['なま','半熟','よく焼き','ほうすい'], answer:3 },
    { text:'請問下列何者是「半熟」的意思?', options:['なま','半熟','よく焼き','ほうすい'], answer:1 },
    { text:'請問下列何者是「全熟」的意思?', options:['なま','半熟','よく焼き','ほうすい'], answer:2 },
    { text:'請問下列何者是圖中內容的翻譯?',image:'audio/雞蛋.jpg', options:['卵','腸詰め','生野菜','ぞぼる'], answer:0 },
    ...
    { text:'翻譯題：卡片回收', options:[
        'どちらからいらっしゃいましたか？',
        'カードを回収お願いします。',
        'カードはありますか？'
      ], answer:1 },
    { text:'翻譯題：請問有拿卡片嗎?', options:[
        'どちらからいらっしゃいましたか？',
        'カードを回収お願いします。',
        'カードはありますか？'
      ], answer:2 },
    { text:'翻譯題：我沒有拿', options:[
        '搭乗券お願いします。',
        '持っていない。',
        'ラインでお待ちください。'
      ], answer:1 },
     { text:'翻譯題：請拿出機票', options:[
        '搭乗券お願いします。',
        '持っていない。',
        'ラインでお待ちください。'
      ], answer:0 },
